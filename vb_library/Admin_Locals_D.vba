...
Public Function setupAuditPlanner() As Collection
    ...
    setupAuditPlanner.Add "Liste f�r Assistenten bereitstellen?", "export.prompt" 'save dialogue header, customize to your language
...
Public Function setupStocklist() As Collection
    ...
    setupStocklist.Add "Liste f�r Assistenten bereitstellen?", "export.prompt" 'save dialogue header, customize to your language
...
Public Function setupTicketSystem() As Collection
    ...
    setupTicketSystem.Add "Liste f�r Assistenten bereitstellen?", "export.prompt" 'save dialogue header, customize to your language
    ...
    setupTicketSystem.Add "Daten wurden bereitgestellt und die Tabelle zur n�chsten Verwendung geleert.", "export.success" 'success message
    setupTicketSystem.Add "Es waren keine Daten verf�gbar!", "export.error" 'error message
    ...
    setupTicketSystem.Add "Warenr�ckstand", "header.column9" 'column header for filtered column
End Function
...
Public Function setupExternalExport() As Collection
    ...
    setupExternalExport.Add Item:="Listen f�r den Assistenten bereitstellen?", Key:="initiate.Confirm" 'query to export
    setupExternalExport.Add "Listen ver�ffentlichen?", "initiate.Title" 'title for query to export
...
Public Function setupExternalDocuments() As Collection
    ...
    setupExternalDocuments.Add "Liste der externen Dokumente f�r den Assistenten bereitstellen?", "export.prompt"
    setupExternalDocuments.Add "Export abgebrochen, es wurde keine Zieldatei gew�hlt.", "export.ErrorMsg"
End Function
...
Public Function setupExternalContracts() As Collection
    ...
    setupExternalContracts.Add "Liste der externen Vertr�ge f�r den Assistenten bereitstellen?", "export.prompt"
    setupExternalContracts.Add "Export abgebrochen, es wurde keine Zieldatei gew�hlt.", "export.ErrorMsg"
End Function
...
Public Function setupInternalDocuments() As Collection
    ...
    setupInternalDocuments.Add "Inhalte ver�ffentlichen?", "initiate.Title"
    setupInternalDocuments.Add "Kopie der Liste ohne Code bereitstellen," & vbNewLine & _
            "Liste der Dokumente f�r den Assistenten bereitstellen," & vbNewLine & _
            "Dokumentenpakete f�r den Assistenten bereitstellen??" & vbNewLine & vbNewLine & _
            "Es wird nicht empfohlen die Bereitstellung im Rahmen der Dokumentenregistrierung durchzuf�hren!", "initiate.Confirm"
    'document list
    ...
    setupInternalDocuments.Add "Liste interner Dokumente f�r den Assistenten bereitstellen?", "export.listPrompt"
    setupInternalDocuments.Add "Dateipfad f�r DOCM-Dateien...", "export.replaceFromTitle"
    setupInternalDocuments.Add "Bitte den Pfad der DOCM-Dateien angeben der durch die n�chste Eingabe ersetzt werden soll.", "export.replaceFromPrompt"
    setupInternalDocuments.Add "E:\Quality Management\documents", "export.replaceFromDefaultPath"
    setupInternalDocuments.Add "Dateipfad f�r PDF-Dateien...", "export.replaceToTitle"
    ...
    setupInternalDocuments.Add "Export abgebrochen, es wurde keine Zieldatei gew�hlt.", "export.ErrorMsg"
    'document bundles
    setupInternalDocuments.Add "Dokumentenpakete f�r den Assistenten bereitstellen?", "export.bundlePrompt"
    ...
    'export without code
    setupInternalDocuments.Add "Excel-Datei ohne Code ver�ffentlichen?", "export.xlsPrompt"
