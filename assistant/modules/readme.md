...
if you have reaccuring sets of documents it might come in handy if you define packages that can be selected, displayed and (using ie11) printed on the fly. these have to be set up manually as a structured javascript object.

dependencies are: datalist for packages
...
dependencies are: datalist of help topics
