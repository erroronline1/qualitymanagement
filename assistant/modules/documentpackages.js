...
var module={
	var:{
		...
		lang:{
			...
			serialPrintLink:{
				en:function(e){return 'Print all documents but '+e;},
				de:function(e){return 'Alle Dokumente außer '+e+' drucken';}},
			primaryCaption:{
	...
	function:{
		...
		gen:function(treatment){
			...
			Object.keys(pack.secondary).forEach(function(index){	secondary+=module.function.linkfile(pack.secondary[index]); });
