...
//		theme.css-filename: { en: 'english title', de: 'german title', extend languages as desired },
		...
		orange:{ en: 'orange', de: 'fox'},
		slate:{ en: 'slate', de: 'schiefer'}
	},
...
//text-blocks within the core file and reusable textblocks for modules
	lang:{
		...
		settingNotificationSelector:{
			en:function(){return 'Show hint #'+(updateTracker.latestMajorUpdate()+1)+' on startup';},
			de:function(){return 'Hinweis #'+(updateTracker.latestMajorUpdate()+1)+' beim Start anzeigen';}},
