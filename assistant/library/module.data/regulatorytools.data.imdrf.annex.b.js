...
regulatorytools.data.imdrf.annex.b = [
  {
  ...
  {
    "term": "Analysis of Data Provided by User/Third Party",
    "code": "B15",
    "definition": "The investigation involved the analysis of relevant data provided by the user (e.g. healthcare professional, patient, clinical engineer) or a third party (e.g. testing facility) in view of supporting the identification of possible causes for the adverse event.",
    "Non-IMDRF Code/Term": "",
    "Status": "",
    "Status Description": "",
    "CodeHierarchy": "B15"
  },
  {
    ...
    "code": "B16",
    "definition": "Further information was obtained which established that the manufacturer of the device involved was not the one to which it was initially attributed. Use in conjunction with C20 and D14.",
    "Non-IMDRF Code/Term": "",
    "Status": "Modified (technical)",
    "Status Description": "Definition was modified on 21 January 2021 (addition of phrase \"Use in conjunction with C20 and D14.\"). For details, refer to comment No. 18 of the Change Log.",
    "CodeHierarchy": "B16"
  },
  {
  ...
  },
  {
    ...
    "code": "B24",
    "definition": "The investigation involved the analysis of the history log files retrieved from the device to support possible causes for the adverse event.",
    "Non-IMDRF Code/Term": "",
    "Status": "New",
    "Status Description": "Term was added on 27 January 2022. For details, refer to comment No. 28 of the Change Log (Release Number 2022).",
    "CodeHierarchy": "B24"
  }
]